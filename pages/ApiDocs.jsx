...
const SECTIONS = [
  ...
  },
  {
    ...
    title: "NorthTV",
    intro:
      "NorthTV (Northlive) : catalogue de chaînes IPTV premium (~965 chaînes). L'endpoint public retourne uniquement des embeds — la clé API upstream n'est jamais exposée. Iframe compatible desktop + mobile. Modal pub obligatoire avant lecture.",
    url: `${BACKEND_URL}/api/v1/public/north/channels`,
    sample: `{
  "count": 965,
  "channels": [
    {
      ...
      "category":   "IPTV",
      "logo":       "",
      "embed_url":  "${BACKEND_URL}/embed/north/france-2-hd-b"
    }
  ]
}`,
  },
  {
    ...
    title: "FrameTV",
    intro:
      "FrameTV (Frembed) : catalogue IPTV mondial paginé (~9 000+ chaînes). Résolution automatique du flux HLS m3u8 côté serveur. Endpoint public renvoie uniquement des embeds — jamais le flux direct. Modal pub obligatoire avant lecture.",
    url: `${BACKEND_URL}/api/v1/public/frame/channels`,
    sample: `{
  "count": 9200,
  "channels": [
    {
      ...
      "group":      "France",
      "logo":       "",
      "embed_url":  "${BACKEND_URL}/embed/frame/40704463696c79db63feff"
    }
  ]
}`,
  },
